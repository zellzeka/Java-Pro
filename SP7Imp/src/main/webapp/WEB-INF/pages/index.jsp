    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="write_contact" class="btn btn-default navbar-btn">Write to
                                CSV file</button></li>
                            <li><button type="button" id="read_contact" class="btn btn-default navbar-btn"> Read from CSV file </button></li>
                ...
                <ul class="pagination">
                    ...
                    <c:if test="${byPatternPages ne null}">
                        <c:forEach var="i" begin="1" end="${byPatternPages}">
                            <li><a href="/search/?page=<c:out value="${i - 1}"/>&pattern=<c:out value="${pattern}"/>">
                                    <c:out value="${i}"/></a></li>
                        </c:forEach>
                    </c:if>
                </ul>
        ...
        <script>
            ...
            $('#write_contact').click(function(){
                let data = { 'toWrite[]' : []};
                $(":checked").each(function() {
                    data['toWrite[]'].push($(this).val());
                });
                $.post("/write", data, function(data, status) {
                    window.location.reload();
                });
            });
            $('#read_contact').click(function(){
